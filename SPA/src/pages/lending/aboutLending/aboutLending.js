...
The platform is simple to use, loan information is well displayed and returns are excellent. I have recommended ThinCats to my friends as my particular endorsement of your product. (Michael)</em></p>
                    <p><strong>View <span style={{textDecoration: 'underline'}}>key statistics</span> including details of our last 10 loans&nbsp;<a title="here" href="https://www.thincats.com.au/statistics/" rel="noopener noreferrer" target="_blank">here</a></strong></p>
                    <h2>Overview</h2>
                    ...
                    <p>It is important that you are aware of the risks of peer-to-peer lending which are elaborated <a href="https://www.thincats.com.au/lending/risks/" target="_blank" rel="noopener noreferrer">here</a>.</p>
...
1) aggregate net assets of at least $2.5 million; OR 2) aggregate gross income for each of the last two financial years of at least $250,000 a year.</p>
                    ...
                    <p><a title="Register" href="https://www.thincats.com.au/register/" rel="noopener noreferrer" target="_blank">Register</a>&nbsp;and review the current loans on our platform.</p>
