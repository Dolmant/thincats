...
export class MemberRegistration extends React.Component<Props> {
    render() {
        return (
            <div className="memberRegistration">
                ...
                <section className="regular-page-content clearfix">
                    ...
                    <p style="text-align: left">To register as a member please read our&nbsp;
<a href="/wp-content/uploads/2014/10/TCA-Membership-Agreement-May16.pdf" target="_blank">terms and conditions</a>&nbsp;and complete the form below.</p>
                    <p style="text-align: left">Registration is currently free and allows you to review the current loans on the platform. There is no obligation to bid.</p>
                    <form method="post" id="um_form_register" className="um_user_form  um_generated_form" encType="multipart/form-data">
                        ...
                        <div className="um_field_container">
                            ...
                            <span className="password_strength">
                                ...
                                <input type="password" name="user_pass_retype" id="um_field_32_register_retype" className="um_field_32 um_input validate[required,equals[um_field_32_register]]" /></p></div><div className="um_field_container">
                                    ...
                                    <input type="email" name="user_email" id="um_field_2_register" className="um_field_2 um_input validate[required,custom[email]]" /><p>
                                        <label id="um_field_2_register_label_retype" className="um_label_top" htmlFor="um_field_2_register_retype">Retype Email</label>
                                        <input type="email" name="user_email_retype" id="um_field_2_register_retype" className="um_field_2 um_input validate[required,custom[email],equals[um_field_2_register]]" /></p></div><div className="um_field_container">
        ...
        <a href="/wp-content/uploads/2014/10/TCA-Membership-Agreement-May16.pdf" target="_blank">terms and conditions</a>.</p>
                        </div>
                        <div className="um_field_container">
                        ...
                        <div className="um_field_container">
                            ...
                            <input type="hidden" name="_status" value="non-verified" id="um_field_33_register" className="um_field_33 um_input" /></div><div className="um_clear">
                            </div>
                        ...
                        <div id="siwp_captcha_container_1">
                            <br />
                            <div style="float: left"><img id="siwp_captcha_image_1" src="https://www.thincats.com.au/wp-content/plugins/securimage-wp/lib/siwp_captcha.php?id=de1e43c59264d4065ac7c8bb5294afb3788f8508" alt="CAPTCHA Image" style="vertical-align: middle;" /></div>
                            <div style="float: left"><a tabIndex="-1" style="border-style: none;" href="#" title="Refresh Image" onClick="siwp_refresh('1', null); this.blur(); return false"><img src="https://www.thincats.com.au/wp-content/plugins/securimage-wp/lib/images/refresh.png" alt="Reload Image" onClick="this.blur()" style="vertical-align: middle; height: 32px; width: 32px" align="bottom" /></a></div><div style="clear: both;"></div>
