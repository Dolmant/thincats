                        ...
                        <div className="row home-content">
                            ...
                            <div className="col-sm-8 left-colHome">
                                <div className="col-lg-12 col-sm-12">
                                    <div className="about-info">
                                        <p>
                                            <img className="alignnone wp-image-5034476 size-full" title="9 fat reasons to lend through ThinCats" src="/assets/borrowed_assets/roason-1.png" alt="9 fat reasons to lend through ThinCats" width="706" height="313" />
                                        </p>
                                        <h2>to borrow or lend through <img className="alignnone wp-image-5034579 size-full" title="thincats" src="/assets/borrowed_assets/thincats.png" alt="" width="203" height="43" style={{height: "30px", paddingBottom: "5px"}} /> <img className="alignright size-full wp-image-5034479 right-img" title="right-img" src="/assets/borrowed_assets/right-img.png" alt="" width="75" height="74" /></h2>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-12 col-sm-12 front-page-widgets">
                                    <div className="slidingDiv overlaydiv  common_box_text" id="box_text1" style={{display: "none"}}>
                                        ...
                                        <p>Borrowers can apply for loans by filling out our&nbsp;<strong><a href="/borrowing/apply-loan/" target="_blank" rel="noopener noreferrer">application form</a>.</strong></p>
                                        <p>Lending is open to wholesale investors and eligible SMSFs.&nbsp;<strong><a href="/register/" target="_blank" rel="noopener noreferrer">Register</a></strong><em>&nbsp;</em>and review the current loans on the platform. There is no obligation to bid and membership is free.</p>
                                        <p>Once approved members can bid fractionally on loans. The minimum bid is $1,000.</p>
                                        <p><em><strong>For key statistics click <a title="here" href="/statistics/" target="_blank" rel="noopener noreferrer">here</a>.</strong></em></p>
                                    ...
                                    <div className="reason_column row">
                                        <div className="reason-img col-lg-4 col-sm-4 common_box" id="reason1">
                                            <div id="slidingDiv" className="show_hide" style={{display: "block"}}>
                                                <p>
                                                    <img className="alignnone wp-image-5034614 size-full" title="reason-1" src="/assets/borrowed_assets/reason-1.png" alt="" width="270" height="267" />
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="reason_column row">
                                        <div className="reason-img col-lg-4 col-sm-4 common_box" id="reason2">
                                            <div id="slidingDiv2" className="show_hide" style={{display: "block"}}>
                                                <p>
                                                    <img className="alignnone wp-image-5034616 size-full" title="reason-2" src="/assets/borrowed_assets/reason-2.png" alt="" width="305" height="281" />
                                                </p>
                                            </div>
                                        </div>
                                        <div className="reason-content col-lg-8 col-sm-8">
                                    ...
                                    <div className="reason_column row">
                                        <div className="reason-img col-lg-4 col-sm-4 common_box" id="reason3">
                                            <div id="slidingDiv3" className="show_hide" style={{display: "block"}}>
                                                <p>
                                                    <img className="alignnone wp-image-5034618 size-full" title="reason-3" src="/assets/borrowed_assets/reason-3.png" alt="" width="276" height="282" />
                                                </p>
                                            </div>
                                        </div>
                                        <div className="reason-content col-lg-8 col-sm-8">
                                    ...
                                    <div className="reason_column row">
                                        <div className="reason-img col-lg-4 col-sm-4 common_box" id="reason4">
                                            <div id="slidingDiv4" className="show_hide" style={{display: "block"}}>
                                                <p>
                                                    <img className="alignnone wp-image-5034620 size-full" title="reason-4" src="/assets/borrowed_assets/reason-4.png" alt="" width="287" height="262" />
                                                </p>
                                            </div>
                                        </div>
                                        <div className="reason-content col-lg-8 col-sm-8">
                                ...
                                <div className="col-lg-12 col-sm-12 front-page-widgets front-page-widgets5">
                                    <div className="slidingDiv5 overlaydiv  common_box_text" id="box_text5" style={{display: "none"}}>
                                        <span className="arrow-top"></span>
                                        <div className="close-btn show_hide" style={{display: "block"}}>close</div>
                                        <p>All our <strong><a href="/borrowing/about-borrowing/" target="_blank" rel="noreferrer noopener">fees and charges</a></strong>&nbsp;to borrowers are clearly detailed on our website.</p>
                                    ...
                                    <div className="reason_column row">
                                        <div className="reason-img col-lg-4 col-sm-4 common_box" id="reason5">
                                            <div id="slidingDiv5" className="show_hide" style={{display: "block"}}>
                                                <p><img className="alignnone wp-image-5034621 size-full" title="reason-5" src="/assets/borrowed_assets/reason-5.png" alt="" width="282" height="262" /></p>
                                            </div>
                                        </div>
                                        <div className="reason-content col-lg-8 col-sm-8">
                                            <div className="reason-inner">
                                ...
                                <div className="col-lg-12 col-sm-12 front-page-widgets front-page-widgets6">
                                    <div className="slidingDiv6 overlaydiv  common_box_text" id="box_text6" style={{display: "none"}}>
                                        <span className="arrow-top"></span>
                                        <div className="close-btn show_hide" style={{display: "block"}}>close</div>
                                        <p>The ThinCats team has very strong credentials in lending particularly to small business and we make sure that you are talking to a decision maker who understands your business and will assist you to tell your story to potential lenders, so that a good result can be achieved by both lenders and borrowers. Check out our&nbsp;<strong><a href="/about/our-team/" target="_blank" rel="noopener noreferrer">management team</a></strong>.</p>
                                    </div>
                                    <div className="reason_column row">
                                        <div className="reason-img col-lg-4 col-sm-4 common_box" id="reason6">
                                            <div id="slidingDiv6" className="show_hide" style={{display: "block"}}>
                                                <p><img className="alignnone wp-image-5034622 size-full" title="reason-6" src="/assets/borrowed_assets/reason-6.png" alt="" width="277" height="267" /></p>
                                            </div>
                                        </div>
                                        <div className="reason-content col-lg-8 col-sm-8">
                                            <div className="reason-inner">
                                    ...
                                    <div className="reason_column row">
                                        <div className="reason-img col-lg-4 col-sm-4 common_box" id="reason7">
                                            <div id="slidingDiv7" className="show_hide" style={{display: "block"}}>
                                                <p><img className="alignnone wp-image-5034624 size-full" title="reason-7" src="/assets/borrowed_assets/reason-7.png" alt="" width="279" height="265" /></p>
                                            </div>
                                        </div>
                                        <div className="reason-content col-lg-8 col-sm-8">
                                            <div className="reason-inner">
                                ...
                                <div className="col-lg-12 col-sm-12 front-page-widgets front-page-widgets8">
                                    <div className="slidingDiv8 overlaydiv  common_box_text" id="box_text8" style={{display: "none"}}>
                                        ...
                                        <p>As a ThinCats lender you can research and build your own personal or SMSF portfolio from a range of secured business loans. To review loans on our platform you only have to <strong><a href="/register/" target="_blank" rel="noopener noreferrer">register</a></strong>&nbsp;as a member. There is no obligation to bid.</p>
                                    ...
                                    <div className="reason_column row">
                                        <div className="reason-img col-lg-4 col-sm-4 common_box" id="reason8">
                                            <div id="slidingDiv8" className="show_hide" style={{display: "block"}}>
                                                <p>
                                                    <img className="alignnone wp-image-5034626 size-full" title="reason-8" src="/assets/borrowed_assets/reason-8.png" alt="" width="290" height="259" />
                                                </p>
                                            </div>
                                        </div>
                                        <div className="reason-content col-lg-8 col-sm-8">
                                    ...
                                    <div className="reason_column row">
                                        <div className="reason-img col-lg-4 col-sm-4 common_box" id="reason9">
                                            <div id="slidingDiv9" className="show_hide" style={{display: "block"}}>
                                                <p>
                                                    <img className="alignnone wp-image-5034627 size-full" title="reason-9" src="/assets/borrowed_assets/reason-9.png" alt="" width="292" height="249" />
                                                </p>
                                            </div>
                                        </div>
                                        <div className="reason-content col-lg-8 col-sm-8">
                            ...
                            <div className="home-sidebar col-sm-4"><li className="widget widget_text">
                                <div className="textwidget">
                                    <section className="sidebar-slider-section">
                                        ...
                                        <div className="sidebar-slide-container cycle-slideshow" data-cycle-fx="scrollHorz" data-cycle-prev=".sidebar-slider-section .left-arrow" data-cycle-next=".sidebar-slider-section .right-arrow" data-cycle-slides=" > .indv-slide" data-cycle-timeout="5000" style={{position: "relative", overflow: "hidden"}}>
                                            <div className="indv-slide cycle-slide cycle-sentinel" style={{position: "static", top: "0px", left: "0px", zIndex: "100", opacity: "1", display: "block", visibility: "hidden"}}>
                                                <figure style={{visibility: "hidden"}}>
                                                    <span className="wistia_embed wistia_async_psiamvfuq6 popover=true popoverContent=link wistia_embed_initialized" style={{display: "inline", visibility: "hidden"}} id="wistia-psiamvfuq6-1">
                                                        <div id="wistia_39.thumb_container" className="wistia_click_to_play" style={{position: "relative", display: "inline"}}>
                                                            <a href="#" style={{visibility: "hidden"}}>
                                                                <img src="/assets/borrowed_assets/video1g.png" alt="" style={{visibility: "hidden"}} />
                                            ...
                                            <div className="indv-slide cycle-slide cycle-slide-active" style={{position: "absolute", top: "0px", left: "0px", zIndex: "99", opacity: "1", display: "block", visibility: "visible"}}>
                                                <figure>
                                                    <span className="wistia_embed wistia_async_psiamvfuq6 popover=true popoverContent=link wistia_embed_initialized" style={{display: "inline"}} id="wistia-psiamvfuq6-2"><div id="wistia_49.thumb_container" className="wistia_click_to_play" style={{position: "relative", display: "inline"}}>
                                                        <a href="#">
                                                            <img src="/assets/borrowed_assets/video1g.png" alt="" />
                                            ...
                                            <div className="indv-slide cycle-slide" style={{position: "absolute", top: "0px", left: "0px", zIndex: "97", visibility: "hidden", opacity: "1", display: "block"}}>
                                                <figure>
                                                    <span className="wistia_embed wistia_async_2nc5twt1mz popover=true popoverContent=link wistia_embed_initialized" style={{display: "inline"}} id="wistia-2nc5twt1mz-1"><div id="wistia_59.thumb_container" className="wistia_click_to_play" style={{position: "relative", display: "inline"}}>
                                                        <a href="#">
                                                            <img src="/assets/borrowed_assets/explainer-video-320x172_p.png" alt="" />
                                            ...
                                            <div className="indv-slide cycle-slide" style={{position: "absolute", top: "0px", left: "0px", zIndex: "96", visibility: "hidden", opacity: "1", display: "block"}}>
                                                <figure>
                                                    <span className="wistia_embed wistia_async_w6o5m30ais popover=true popoverContent=link wistia_embed_initialized" style={{display: "inline"}} id="wistia-w6o5m30ais-1">
                                                        <div id="wistia_72.thumb_container" className="wistia_click_to_play" style={{position: "relative", display: "inline"}}>
                                                            <a href="#">
                                                                <img src="/assets/borrowed_assets/AK-play-icon.png" alt="" />
                                            ...
                                            <div className="indv-slide cycle-slide" style={{position: "absolute", top: "0px", left: "0px", zIndex: "98", visibility: "hidden", opacity: "1", display: "block"}}>
                                                <figure>
                                                    <span className="wistia_embed wistia_async_7yj84e44zs popover=true popoverContent=link wistia_embed_initialized" style={{display: "inline"}} id="wistia-7yj84e44zs-1">
                                                        <div id="wistia_85.thumb_container" className="wistia_click_to_play" style={{position: "relative", display: "inline"}}>
                                                            <a href="#">
                                                                <img src="/assets/borrowed_assets/Screen-Shot-2016-11-10-at-8.26.12-PM.png" alt="" />
                            ...
                            <li className="widget widget_text">
                                    ...
                                    <div className="content login">
                                            ...
                                            <form className="lwa-form" action="/wp-login.php" method="post">
                                                    <div>
                                            ...
                                            <p style={{margin: "11px 0px"}}><a href="/resetpass-2/?action=lostpassword" title="Lost Password">Forgot/Change password?</a></p>
