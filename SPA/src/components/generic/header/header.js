                            ...
                            <ul className="sf-menu">
                                ...
                                <li id="menu-item-1497" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1497"><a href="https://www.thincats.com.au/lending/">Lending</a>
                                    <ul className="sub-menu">
                                        ...
                                        <li id="menu-item-1653" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-1653"><a rel="noopener noreferrer" target="_blank" href="/wp-content/uploads/2014/10/TCA-Membership-Agreement-May16.pdf">Membership Agreement</a></li>
                                ...
                                <li id="menu-item-1411" className="menu-item menu-item-type-post_type menu-item-object-page current-page-ancestor current-menu-ancestor current-menu-parent current-page-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-1411"><a href="https://www.thincats.com.au/about/">About us</a>
                                    <ul className="sub-menu">
                                        ...
                                        <li id="menu-item-1655" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-1655"><a rel="noopener noreferrer" target="_blank" href="/wp-content/uploads/2014/10/TCA-Privacy-Policy-v1.1.pdf">Privacy Policy</a></li>
                                    </ul>
                                </li>
                                            ...
                                            <form className="lwa-register-form" action="https://www.thincats.com.au/wp-signup.php" method="post">
                                                <div>
                                                    ...
                                                    <div id="siwp_captcha_input_0">
                                                        <br />
                                                        <div style={{float: 'left'}}><img id="siwp_captcha_image_0" src="https://www.thincats.com.au/wp-content/plugins/securimage-wp/lib/siwp_captcha.php?id=2efce8cbdda8c5e60f5fe673315b91eee8e7fb24" alt="CAPTCHA Image" style={{verticalAlign: 'middle'}} /></div>
                                                        <div style={{float: 'left'}}><a tabIndex="-1" style={{borderStyle: 'none'}} href="#" title="Refresh Image" ><img src="https://www.thincats.com.au/wp-content/plugins/securimage-wp/lib/images/refresh.png" alt="Reload Image" onClick={() => this.blur()} style={{verticalAlign: 'middle', height: '32px', width: '32px'}} align="bottom" /></a></div><div style={{clear: 'both'}}></div>
